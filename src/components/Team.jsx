...
function Team() {
    return (
        <div className="teams">
            ...
            <p>Pfaseant placersaeted egatenrs crat rhone magna rutum tellus loaretam</p>
        ...
        <div className="designers">
            ...
            <div className="designer">
               ...
               <h2>Freddie Stewart</h2>
               <p>UI Designer</p>
            </div>
            <div className="designer">
                <img src="https://s3-alpha-sig.figma.com/img/a0cd/65ad/b10e274c79902a6e1e19bd93af507ec6?Expires=1724630400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=BhmAmPRDdIeiBd2nqGBuOEzT5QsAhUuqy6xzGoEA48T4XM2KOLVmc0~CMbAccD9zslCt-676TKwhUPXNSI-lBMznMCIEdG~o0U3lKOoz8JzecfpNjV-MsYCeFYgzkcASAsZZ1u~1l3z8XLEnxRZ6cd2PBpDsP60s1d44wJlNz9eiBjrWkxwPila4l3xBw0azSwqC3yDWHjhxZFcDIb81yAfhYO3hAnGYp5-swo~DYrlFDXS3BUx2vY6RsEsKi3KX6WaZftxq9NIeEI-MQJXaUE4eI6OTjN9NQF-5FQdgqBGhe88GQ7yiA3jA1r3D1I3IHSRKhIBFe5XFKuDZsm4I2A__" alt="" />
                <h2>Cameron Butcher</h2>
                <p>UX Designer</p>
            </div>
        </div>
        </div>
